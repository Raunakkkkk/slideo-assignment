...
export const DocumentCard: React.FC<DocumentCardProps> = ({
  ...
  return (
    <div 
      ...
      onMouseEnter={(e) => {
        e.currentTarget.style.boxShadow = theme.mode === 'light'
    ...
    >
      <div className="p-4">
        ...
        <button
          ...
          onMouseEnter={(e) => {
            e.currentTarget.style.color = theme.mode === 'light' ? '#2563eb' : '#93c5fd';
            e.currentTarget.style.backgroundColor = theme.mode === 'light' ? '#eff6ff' : 'rgba(59, 130, 246, 0.1)';
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.color = theme.mode === 'light' ? '#3b82f6' : '#60a5fa';
